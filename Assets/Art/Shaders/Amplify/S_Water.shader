	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 color59 = IsGammaSpace() ? float4(0.4705882,0.4117647,0.1568628,0.7843137) : float4(0.1878208,0.1412633,0.02121902,0.7843137);
				float time54 = 0.0;
